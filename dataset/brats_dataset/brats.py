...
import random
BASE_PATH = '/root/data/brats/ViT_Multi' 
#BASE_PATH = '/root/data/brats/ViT_96'
...
def build_multi_dataset(mode, sizes, args=None, transforms = None, use_z_score=False):
    ...
    return BratsDataMulti(mode=mode, image_files=image_files, label_files=label_files, transform=transforms, use_z_score=use_z_score)
