...
def main(args):
    ...
    for idx in range(5):
        ...
        model = get_models(model_name='pix2struct', args=args)
        model.to(device)
        ...
        #save as pickle file
        # with open(os.path.join("/root/projects/vit/output_dir_test/glioma_ga2", "probabilities.pkl"), 'wb') as f:
        #     pickle.dump(probabilities, f)

        # with open(os.path.join("/root/projects/vit/output_dir_test/glioma_ga2", "target.pkl"), 'wb') as f:
