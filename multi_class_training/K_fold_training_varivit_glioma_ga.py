...
sys.stdout = open('/root/sys_out_ga', 'w')
...
def main(args):
    ...
    split_index_path = os.path.join(PROJECT_ROOT_DIR, "glioma_multi", 'k_fold', 'indices_file')
    ...
    for idx in range(5):
        ...
        model = get_models(model_name='varivit', args=args)
        model.to(device)
